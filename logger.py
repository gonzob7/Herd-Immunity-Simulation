class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
        ...
        file.write(f"pop_size: {pop_size} \t vacc_percentage: {vacc_percentage} \t virus: {virus_name} \t mortality_rate: {mortality_rate} \t basic_repro_num: {basic_repro_num}\n")
        file.close()
    ...
    def log_infection_survival(self, person, did_die_from_infection):
        ...
        if did_die_from_infection == True:
            file.write(f"Person {person._id} died from infection!\n")
        else:
            file.write(f"Person {person._id} survived infection!\n")
        file.close()
